...
bool message_info__msg__test__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_info.msg._test.Test", full_classname_dest, 27) == 0);
  }
  message_info__msg__Test * ros_message = _ros_message;
  {  // a
...
PyObject * message_info__msg__test__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_info.msg._test");
