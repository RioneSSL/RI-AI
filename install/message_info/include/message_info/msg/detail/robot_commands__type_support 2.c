...
{
  const message_info__msg__RobotCommand__Sequence * member =
    (const message_info__msg__RobotCommand__Sequence *)(untyped_member);
  return member->size;
}
...
{
  message_info__msg__RobotCommand__Sequence * member =
    (message_info__msg__RobotCommand__Sequence *)(untyped_member);
  return &member->data[index];
}
  ...
  void * untyped_member, size_t size)
{
  message_info__msg__RobotCommand__Sequence * member =
    (message_info__msg__RobotCommand__Sequence *)(untyped_member);
  message_info__msg__RobotCommand__Sequence__fini(member);
  return message_info__msg__RobotCommand__Sequence__init(member, size);
}
