...
{
  new (message_memory) sender::msg::Test(_init);
}

void Test_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sender::msg::Test *>(message_memory);
  typed_message->~Test();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Test_message_member_array[2] = {
  {
    ...
    offsetof(sender::msg::Test, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sender::msg::Test, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Test_message_members = {
  "sender::msg",  // message namespace
  "Test",  // message name
  2,  // number of fields
  sizeof(sender::msg::Test),
...
{
  return &::sender::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sender, msg, Test)() {
  return &::sender::msg::rosidl_typesupport_introspection_cpp::Test_message_type_support_handle;
}
