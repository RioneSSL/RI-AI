...
#include <stddef.h>
#include "sender/msg/detail/test__rosidl_typesupport_introspection_c.h"
#include "sender/msg/rosidl_typesupport_introspection_c__visibility_control.h"
...
static rosidl_typesupport_introspection_c__MessageMember Test__rosidl_typesupport_introspection_c__Test_message_member_array[2] = {
  {
    ...
    offsetof(sender__msg__Test, a),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sender__msg__Test, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Test__rosidl_typesupport_introspection_c__Test_message_members = {
  "sender__msg",  // message namespace
  "Test",  // message name
  2,  // number of fields
  sizeof(sender__msg__Test),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_sender
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sender, msg, Test)() {
