...
struct RobotCommands_
{
  ...
  using _commands_type =
    std::vector<message_info::msg::RobotCommand_<ContainerAllocator>, typename ContainerAllocator::template rebind<message_info::msg::RobotCommand_<ContainerAllocator>>::other>;
  ...
  Type & set__commands(
    const std::vector<message_info::msg::RobotCommand_<ContainerAllocator>, typename ContainerAllocator::template rebind<message_info::msg::RobotCommand_<ContainerAllocator>>::other> & _arg)
  {
    this->commands = _arg;
    return *this;
  }
