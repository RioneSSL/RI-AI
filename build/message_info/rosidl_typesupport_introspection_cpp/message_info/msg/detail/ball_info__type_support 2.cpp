...
{
  new (message_memory) message_info::msg::BallInfo(_init);
}

void BallInfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<message_info::msg::BallInfo *>(message_memory);
  typed_message->~BallInfo();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BallInfo_message_member_array[1] = {
  {
    "pose",  // name
    ...
    offsetof(message_info::msg::BallInfo, pose),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BallInfo_message_members = {
  ...
  1,  // number of fields
  sizeof(message_info::msg::BallInfo),
...
{
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::BallInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, message_info, msg, BallInfo)() {
  return &::message_info::msg::rosidl_typesupport_introspection_cpp::BallInfo_message_type_support_handle;
}
