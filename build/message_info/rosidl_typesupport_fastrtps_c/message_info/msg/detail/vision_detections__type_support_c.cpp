...
#include "message_info/msg/detail/vision_detections__rosidl_typesupport_fastrtps_c.h"
...
#include "message_info/msg/detail/detection_frame__functions.h"  // frames
...
using _VisionDetections__ros_msg_type = message_info__msg__VisionDetections;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VisionDetections__ros_msg_type * ros_message = static_cast<const _VisionDetections__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VisionDetections__ros_msg_type * ros_message = static_cast<_VisionDetections__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: frames
  {
    ...
    if (ros_message->frames.data) {
      message_info__msg__DetectionFrame__Sequence__fini(&ros_message->frames);
    }
    if (!message_info__msg__DetectionFrame__Sequence__init(&ros_message->frames, size)) {
      return "failed to create array for field 'frames'";
    }
    auto array_ptr = ros_message->frames.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
size_t get_serialized_size_message_info__msg__VisionDetections(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _VisionDetections__ros_msg_type * ros_message = static_cast<const _VisionDetections__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _VisionDetections__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_message_info__msg__VisionDetections(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_message_info
size_t max_serialized_size_message_info__msg__VisionDetections(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_message_info__msg__VisionDetections(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_VisionDetections = {
  "message_info::msg",
  "VisionDetections",
...
static rosidl_message_type_support_t _VisionDetections__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VisionDetections,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_info, msg, VisionDetections)() {
  return &_VisionDetections__type_support;
}
