...
#include "sender/msg/detail/test__rosidl_typesupport_fastrtps_c.h"
...
#include "sender/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Test__ros_msg_type = sender__msg__Test;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sender
size_t get_serialized_size_sender__msg__Test(
  const void * untyped_ros_message,
...
static uint32_t _Test__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sender__msg__Test(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sender
size_t max_serialized_size_sender__msg__Test(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_sender__msg__Test(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sender, msg, Test)() {
