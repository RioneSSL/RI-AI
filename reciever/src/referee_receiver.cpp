...
#include "proto_info/referee.pb.h"
...
public:
  ...
  : Node("Masuo")
  {
    pub = this->create_publisher<message_info::msg::Referee>("referee_info", 1);
...
private:
  ...
  void convert_team_info(
    const SSL_Referee_TeamInfo & proto_team, message_info::msg::RefereeTeamInfo & team_info)
  {
  ...
  {
    auto msg = message_info::msg::Referee();
  ...
  rclcpp::Publisher<message_info::msg::Referee>::SharedPtr pub;
