...
public:
	...
	message_info::msg::RobotCommand main(message_info::msg::DetectionBall ball, message_info::msg::DetectionRobot robot, message_info::msg::DetectionRobot attacker, message_info::msg::GoalInfo goal, bool &kick_flag;
